...
export const vascularVeinRemovalService: Service = {
  ...
  previewDescription: "Eliminate spider veins and broken capillaries with advanced vascular removal treatments.",
  fullDescription: "Restore clear, beautiful skin with professional vascular vein removal at Vivi Aesthetics & Spa in Calgary. Our advanced laser and IPL treatments effectively eliminate spider veins, broken capillaries, and vascular lesions on the face and body. Using cutting-edge technology with precise wavelengths, we target hemoglobin in unwanted blood vessels while protecting surrounding tissue. Whether you're dealing with facial redness, leg spider veins, or cherry angiomas, our experienced practitioners deliver safe, effective results with minimal discomfort and no downtime. Achieve smoother, clearer skin and renewed confidence with our customized vascular treatment protocols.",
  
  metaTitle: "Vascular Vein Removal Calgary | Spider Vein Treatment | Vivi Aesthetics & Spa",
  metaDescription: "Professional vascular vein removal in Calgary. Advanced laser and IPL treatments for spider veins, broken capillaries, and facial redness at Vivi Aesthetics & Spa.",
  keywords: ["vascular vein removal calgary", "spider vein removal calgary", "broken capillaries treatment", "facial vein removal", "telangiectasia treatment", "laser vein removal", "IPL vascular treatment", "cherry angioma removal calgary"],
  ...
  openGraph: {
    ...
    description: "Eliminate spider veins and broken capillaries with advanced laser treatments. Clear, beautiful skin with professional vascular removal.",
    image: "/images/services/vascular-vein-removal/vascular-vein-removal-in-calgary-001.webp",
  ...
  twitter: {
    ...
    title: "Vascular Vein Removal Calgary | Vivi Aesthetics & Spa",
    description: "Say goodbye to spider veins and facial redness. Advanced treatments for clear, confident skin.",
    image: "/images/services/vascular-vein-removal/vascular-vein-removal-in-calgary-002.webp",
  },
  ...
  faqs: [
    {
      question: "What types of vascular lesions can be treated with laser removal?",
      answer: "We can effectively treat spider veins (telangiectasias), broken capillaries, facial redness, cherry angiomas, spider nevi, port wine stains, and reticular veins. Each type requires specific laser parameters for optimal results."
    },
    {
      question: "How many sessions are typically needed for vascular vein removal?",
      answer: "Most patients see significant improvement after 1-3 treatments, depending on the size, depth, and number of vessels. Facial vessels often respond faster than leg veins, with sessions spaced 4-8 weeks apart for optimal healing."
    },
    {
      question: "Does vascular vein removal hurt and what does treatment feel like?",
      answer: "Treatment sensation is often described as a rubber band snapping against the skin. Our advanced cooling systems minimize discomfort, and most patients tolerate treatment well without anesthesia. Pain levels are generally much lower than sclerotherapy."
    },
    {
      question: "What should I expect after vascular vein removal treatment?",
      answer: "Treated vessels may appear darker initially as blood coagulates, then gradually fade over 2-8 weeks. Mild redness and swelling may occur for 24-48 hours. Most patients return to normal activities immediately with proper sun protection."
    },
    {
      question: "Are there any risks or side effects with vascular vein removal?",
      answer: "Side effects are generally minimal and temporary, including redness, swelling, or temporary pigmentation changes. Serious complications are rare when performed by experienced practitioners. Proper pre- and post-care minimize risks."
    },
    {
      question: "Can vascular vein removal prevent new spider veins from forming?",
      answer: "While treatment effectively eliminates existing vessels, it doesn't prevent new ones from developing due to genetics, hormones, or lifestyle factors. However, treated vessels typically don't return, and maintenance treatments can address new formations."
    }
  ],
  ...
  testimonials: [
    {
      name: "Patricia M.",
      rating: 5,
      quote: "The laser treatment completely eliminated the spider veins on my face that I'd been covering with makeup for years. The results were visible immediately and I feel so much more confident!",
      treatment: "Facial Spider Vein Removal"
    },
    {
      name: "Robert K.",
      rating: 5,
      quote: "I was amazed by how quick and comfortable the treatment was. The broken capillaries on my nose disappeared after just two sessions. Professional service and excellent results!",
      treatment: "Broken Capillary Treatment"
    },
    {
      name: "Linda S.",
      rating: 5,
      quote: "After years of being self-conscious about spider veins on my legs, I finally feel comfortable wearing shorts again. The laser removal was so much better than I expected!",
      treatment: "Leg Spider Vein Removal"
    },
    {
      name: "Michael T.",
      rating: 5,
      quote: "The cherry angiomas on my chest were bothering me for years. The removal process was quick, virtually painless, and the results are perfect - no scarring at all!",
      treatment: "Cherry Angioma Removal"
    },
    {
      name: "Sarah J.",
      rating: 5,
      quote: "My facial redness from broken capillaries has dramatically improved. The staff explained everything thoroughly and the treatment exceeded my expectations. Highly recommend!",
      treatment: "Facial Vascular Treatment"
    },
    {
      name: "David R.",
      rating: 5,
      quote: "Professional, knowledgeable staff and amazing technology. The spider veins around my ankles that I thought would never go away are completely gone. Worth every penny!",
  ...
  structuredData: {
    ...
    "description": "Advanced laser and IPL treatments for eliminating spider veins, broken capillaries, and vascular lesions using selective photothermolysis technology.",
    ...
    "preparation": "Avoid sun exposure and blood thinners, discontinue topical retinoids 7 days prior to treatment",
    "howPerformed": "Targeted laser energy absorption by hemoglobin in blood vessels causing coagulation and vessel closure",
    "indication": {
