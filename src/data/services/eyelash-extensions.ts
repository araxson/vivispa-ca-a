...
export const eyelashExtensionsService: Service = {
  ...
  keywords: [
    ...
    "hybrid lashes",
    "lash extensions downtown calgary",
    "calgary lash studio",
  ],
  ...
  openGraph: {
    ...
    image: "/images/services/eyelash-extensions/eyelash-extensions-in-calgary-001.webp", // Using service.image
    url: "https://vivispa.ca/services/eyelash-extensions", // Using service.canonicalUrl
    type: "website",
  },
  ...
  faqs: [
    {
      ...
      answer:
        "Eyelash extensions follow your natural lash growth cycle and typically last 4-6 weeks with proper care. Most clients schedule fill appointments every 2-3 weeks to maintain optimal fullness as natural lashes shed and new ones grow.",
    },
    {
      question: "Will eyelash extensions damage my natural lashes?",
      answer:
        "When applied correctly by a certified professional using appropriate techniques and quality adhesive, eyelash extensions will not damage natural lashes. Proper isolation and application methods are essential to prevent stress on natural lash follicles.",
    },
    {
      question:
        "Can I wear makeup and use skincare products with eyelash extensions?",
      answer:
        "Yes, but avoid oil-based products around the eye area as they can break down the adhesive. Water-based mascara can be applied to the tips if desired, though most clients find it unnecessary. Use gentle, oil-free cleansers and avoid rubbing the eye area.",
    },
    {
      question: "What aftercare is required for eyelash extensions?",
      answer:
        "Keep extensions dry for 24-48 hours after application, avoid oil-based products, gently brush with a clean spoolie daily, sleep on your back when possible, and avoid rubbing or pulling on the extensions. Regular fill appointments help maintain the best appearance.",
    },
    {
      question:
        "What's the difference between classic, volume, and hybrid lash techniques?",
      answer:
        "Classic lashes involve applying one extension per natural lash for natural enhancement. Volume uses multiple ultra-fine extensions per natural lash for fuller, more dramatic results. Hybrid combines both techniques for varied texture and natural-looking fullness.",
    },
    {
      question: "Are eyelash extensions suitable for everyone?",
      answer:
        "Most people can wear eyelash extensions, but those with very weak or damaged natural lashes, certain eye conditions, or allergies to adhesive components may need to avoid them. A consultation and possible patch test can determine suitability.",
    },
  ],
  ...
  testimonials: [
    {
      ...
      rating: 5,
      quote:
        "Absolutely love my lash extensions from Vivi Aesthetics! The application was comfortable and the results are stunning. I wake up feeling glamorous every single day.",
    ...
    },
    {
      ...
      rating: 5,
      quote:
        "The volume lashes gave me exactly the dramatic look I wanted while still appearing natural. The quality is exceptional and they last exactly as promised. Highly recommend!",
    ...
    },
    {
      ...
      rating: 5,
      quote:
        "I've tried several lash studios in Calgary, and Vivi Aesthetics is by far the best. The attention to detail and professionalism is outstanding. My lashes always look perfect.",
    ...
    },
    {
      ...
      rating: 5,
      quote:
        "As someone with naturally short lashes, extensions have been life-changing. The team at Vivi Aesthetics created beautiful, natural-looking lashes that complement my eyes perfectly.",
      treatment: "Classic Eyelash Extensions",
    },
    {
      name: "Jennifer M.",
      rating: 5,
      quote:
        "The hybrid technique was perfect for my lifestyle - not too dramatic but definitely noticeable. I save so much time on my morning routine and always feel put-together.",
      treatment: "Hybrid Eyelash Extensions",
    },
    {
      name: "Christina L.",
      rating: 5,
      quote:
        "Professional, clean environment and amazing results. My lashes feel lightweight and look incredibly natural. The retention is excellent - they last exactly as expected.",
      treatment: "Volume Eyelash Extensions",
    },
  ],
  ...
  structuredData: {
    ...
    description:
      "Professional eyelash extension services offering classic, volume, and hybrid techniques for natural-looking lash enhancement.",
    ...
    preparation:
      "Arrive without eye makeup, contact lenses, or oil-based eye products",
    howPerformed:
      "Individual synthetic lash application using medical-grade adhesive and precision techniques",
    indication: {
