...
export const hydrofacialService: Service = {
  ...
  previewDescription: 'Advanced multi-step facial treatment that cleanses, exfoliates, extracts, and hydrates skin simultaneously.',
  fullDescription: 'HydroFacial is a patented, non-invasive facial treatment that combines cleansing, exfoliation, extraction, hydration, and antioxidant protection in a single session. This revolutionary treatment uses a unique spiral design handpiece and patented Vortex-Fusion delivery system to remove dead skin cells and impurities while simultaneously delivering moisturizing serums into the skin. The multi-step process addresses various skin concerns including fine lines, wrinkles, enlarged pores, oily or acne-prone skin, hyperpigmentation, and dehydration, making it suitable for all skin types and conditions.',
  
  metaTitle: 'HydroFacial Calgary | Deep Cleansing & Hydration | Vivi Aesthetics & Spa',
  metaDescription: 'Book your HydroFacial at Vivi Aesthetics & Spa Calgary for a non-invasive treatment that cleanses, exfoliates, and hydrates. Achieve radiant skin today!',
  keywords: ['hydrofacial calgary', 'hydrofacial in calgary', 'hydrofacial treatment calgary', 'best hydrofacial in calgary', 'facial treatment', 'skin rejuvenation', 'calgary spa', 'hydradermabrasion'],
  ...
  openGraph: {
    ...
    description: 'Experience the ultimate skin rejuvenation with our HydroFacial treatment. Cleanse, exfoliate, and hydrate your skin in one session.',
  ...
  twitter: {
    ...
    description: 'Get smooth, hydrated, and youthful skin with our HydroFacial treatment. Book now!',
  ...
  faqs: [
    {
      question: "What exactly is a HydroFacial and how does it differ from regular facials?",
      answer: "HydroFacial is a patented treatment that uses advanced technology to cleanse, extract, and hydrate skin simultaneously. Unlike traditional facials, it uses a specialized vortex-fusion system that provides immediate results without irritation or downtime."
    },
    {
      question: "Is there any downtime after a HydroFacial treatment?",
      answer: "No, there's no downtime required with HydroFacial. You can return to your normal activities immediately after treatment and even apply makeup right away. Some patients may experience mild redness that resolves within hours."
    },
    {
      question: "How often should I receive HydroFacial treatments for optimal results?",
      answer: "For optimal results, treatments are typically recommended every four to six weeks to align with the skin's natural renewal cycle. However, frequency can be adjusted based on individual skin needs, concerns, and treatment goals."
    },
    {
      question: "Is HydroFacial suitable for sensitive or problematic skin?",
      answer: "Yes, HydroFacial is specifically designed to be gentle and suitable for all skin types, including sensitive, acne-prone, or mature skin. The treatment can be customized with different serums to address specific skin concerns safely."
    },
    {
      question: "What skin concerns does HydroFacial effectively address?",
      answer: "HydroFacial effectively treats multiple concerns including dehydration, fine lines, enlarged pores, uneven skin texture, hyperpigmentation, oily skin, and signs of environmental damage while providing overall skin rejuvenation."
    },
    {
      question: "Can HydroFacial be combined with other skin treatments?",
      answer: "Yes, HydroFacial can be safely combined with many other treatments or used as a preparatory treatment before procedures. However, timing and combination protocols should be determined by a qualified skincare professional based on individual needs."
    }
  ],
  ...
  testimonials: [
    {
      name: "Sarah M.",
      rating: 5,
      quote: "My skin has never looked better! The HydroFacial at Vivi Aesthetics gave me immediate results with no irritation. I'm glowing!",
      treatment: "HydroFacial"
    },
    {
      name: "Jennifer L.",
      rating: 5,
      quote: "I love that there's no downtime. I get my HydroFacial during lunch and go back to work with perfect skin. Highly recommend!",
      treatment: "HydroFacial"
    },
    {
      name: "Michelle K.",
      rating: 5,
      quote: "After struggling with enlarged pores for years, the HydroFacial has finally given me the smooth, refined skin I've always wanted.",
      treatment: "HydroFacial"
    },
    {
      name: "Amanda R.",
      rating: 5,
      quote: "The instant glow and hydration from HydroFacial is amazing. My skin feels so soft and looks radiant. It's become my monthly must-have treatment.",
      treatment: "HydroFacial"
    },
    {
      name: "Lisa P.",
      rating: 5,
      quote: "As someone with sensitive skin, I was nervous about trying new treatments. HydroFacial was gentle yet effective, giving me the best skin of my life.",
      treatment: "HydroFacial"
    },
    {
      name: "Rebecca T.",
      rating: 5,
      quote: "The customized serums and gentle extraction process make HydroFacial perfect for my combination skin. I see improvements after every session.",
      treatment: "HydroFacial"
    }
  ],
  ...
  structuredData: {
    ...
    "description": "A patented multi-step facial treatment providing cleansing, exfoliation, extraction, hydration, and antioxidant protection in a single session.",
    ...
    "howPerformed": "Non-invasive procedure using patented Vortex-Fusion technology for multi-step skin treatment",
    "indication": {
