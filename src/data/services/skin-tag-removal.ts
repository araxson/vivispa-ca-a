...
export const skinTagRemovalService: Service = {
  ...
  previewDescription: "Safe and effective skin tag and mole removal treatments using advanced medical techniques.",
  fullDescription: "Skin tag removal is a common dermatological procedure that safely eliminates benign skin growths known as acrochordons, along with other benign lesions such as seborrheic keratoses, dermatosis papulosa nigra, and small benign moles. These harmless skin growths can appear anywhere on the body but are most commonly found in areas where skin experiences friction, such as the neck, underarms, eyelids, and groin areas. Professional removal ensures optimal cosmetic outcomes while maintaining the highest safety standards through various proven medical techniques.",
  
  metaTitle: "Skin Tag Removal Calgary | Safe Mole Removal | Vivi Aesthetics & Spa",
  metaDescription: "Professional skin tag and mole removal in Calgary. Safe, effective treatment for unwanted skin growths using advanced techniques at Vivi Aesthetics & Spa.",
  keywords: ["skin tag removal calgary", "mole removal calgary", "skin lesion removal calgary", "acrochordon removal", "benign lesion removal", "dermatosis papulosa nigra", "seborrheic keratosis removal", "professional skin tag removal"],
  ...
  openGraph: {
    ...
    description: "Safe, professional removal of skin tags, moles, and benign lesions. Achieve smooth, flawless skin with minimal discomfort.",
    image: "/images/services/skin-tag-removal/skin-tag-removal-in-calgary-001.webp",
  ...
  twitter: {
    ...
    title: "Skin Tag Removal Calgary | Vivi Aesthetics & Spa",
    description: "Remove unwanted skin tags and moles safely and effectively. Professional care for smooth, confident skin.",
    image: "/images/services/skin-tag-removal/skin-tag-removal-in-calgary-002.webp",
  },
  ...
  faqs: [
    {
      ...
      answer: "Skin tags are benign, soft flesh-colored growths that hang from the skin surface. They develop due to friction, genetic factors, hormonal changes, aging, and insulin resistance. They are completely harmless but can cause cosmetic concerns or physical irritation."
    },
    {
      question: "Is skin tag removal painful?",
      answer: "Professional skin tag removal involves minimal discomfort. Local anesthesia is used to ensure patient comfort during the procedure. Most patients report little to no pain during treatment, with mild tenderness possible for a day or two afterward."
    },
    {
      question: "Will skin tags grow back after removal?",
      answer: "Properly removed skin tags will not regrow in the same location since the entire growth, including its base, is eliminated. However, new skin tags may develop elsewhere due to genetic predisposition, friction, or other contributing factors."
    },
    {
      question: "How can I tell if a growth is a benign skin tag or something more serious?",
      answer: "Skin tags are typically soft, flesh-colored, and hang from the skin on a thin stalk. Any growth that is hard, irregular, changes color or size, bleeds spontaneously, or has multiple colors should be evaluated by a medical professional immediately."
    },
    {
      question: "What should I expect during the healing process?",
      answer: "Healing typically occurs within one to two weeks. The treated area may appear red initially, then form a small scab that naturally falls off. Proper wound care accelerates healing and minimizes scarring. Most people can return to normal activities immediately."
    },
    {
      question: "Can multiple skin tags be removed in one session?",
      answer: "Yes, multiple skin tags can often be treated during a single appointment. The number that can be safely removed depends on their size, location, and the patient's overall health. Your practitioner will determine the most appropriate treatment plan."
    }
  ],
  ...
  testimonials: [
    {
      name: "Mary B.",
      rating: 5,
      quote: "I had several skin tags on my neck that made me self-conscious about wearing certain clothing. The removal was quick and painless, and there's absolutely no trace they were ever there!",
      treatment: "Skin Tag Removal - Neck"
    },
    {
      name: "James R.",
      rating: 5,
      quote: "The removal technique was incredibly precise and efficient. Multiple skin tags were removed in one visit with no complications. The professionalism and care were outstanding.",
      treatment: "Multiple Skin Tag Removal"
    },
    {
      name: "Sandra K.",
      rating: 5,
      quote: "I was initially worried about removing a mole, but the staff explained everything clearly and made me feel comfortable. The results gave me complete peace of mind and the healing was perfect.",
      treatment: "Mole Removal with Histology"
    },
    {
      name: "David M.",
      rating: 5,
      quote: "After years of irritation from skin tags under my arms, I finally got them removed. The treatment was quick and effective. I wish I had done this sooner!",
      treatment: "Skin Tag Removal"
    },
    {
      name: "Lisa T.",
      rating: 5,
      quote: "The consultation was thorough and the removal technique was perfectly suited to my needs. The healing was much faster than I expected and the results are fantastic.",
      treatment: "Skin Tag Removal"
    },
    {
      name: "Michael P.",
      rating: 5,
      quote: "Professional service from start to finish. The skin tags around my eyes were removed with precision. No pain, no scarring, just excellent results. Highly recommend!",
  ...
  structuredData: {
    ...
    "description": "Professional removal of skin tags, moles, and benign skin lesions using advanced medical techniques for optimal cosmetic outcomes.",
    "procedureType": "CosmeticProcedure",
    "bodyLocation": "Various body locations including neck, underarms, eyelids, and torso",
    "image": "/images/services/skin-tag-removal/skin-tag-removal-in-calgary-001.webp",
    "url": "https://vivispa.ca/services/skin-tag-removal",
    "provider": {
      "@type": "LocalBusiness",
    ...
    "preparation": "Assessment of lesions and administration of appropriate anesthesia",
    "howPerformed": "Minimally invasive medical procedures for safe and effective lesion removal",
    "indication": {
