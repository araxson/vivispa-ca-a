...
export const laserHairRemovalService: Service = {
  ...
  previewDescription: 'Advanced laser technology for permanent hair reduction on all skin types.',
  fullDescription: 'Laser hair removal is a medical procedure that uses concentrated light energy to permanently reduce unwanted hair growth. The treatment works by targeting the melanin in hair follicles with specific wavelengths of light, causing controlled thermal damage that prevents future hair growth. This non-invasive procedure can be performed on virtually any area of the body and is suitable for all skin types when appropriate laser systems are used. Laser hair removal offers a long-term solution to unwanted hair, eliminating the need for regular shaving, waxing, or other temporary hair removal methods.',

  metaTitle: 'Laser Hair Removal Calgary | Permanent Hair Reduction | Vivi Aesthetics & Spa',
  metaDescription: 'Book safe and effective laser hair removal at Vivi Aesthetics & Spa Calgary. Advanced technology for permanent hair reduction on all skin types. Get smooth skin today!',
  keywords: ['laser hair removal calgary', 'permanent hair reduction calgary', 'hair removal calgary', 'calgary laser spa', 'smooth skin treatment', 'diode laser hair removal', 'ipl hair removal calgary', 'laser hair removal downtown'],
  ...
  heroVideo: {
    ...
    poster: '/images/services/laser-hair-removal/laser-hair-removal-in-calgary-001.webp'
  },
  ...
  twitter: {
    ...
    description: 'Say goodbye to unwanted hair with our advanced laser hair removal. Permanent results with minimal discomfort.',
    image: '/images/services/laser-hair-removal/laser-hair-removal-in-calgary-003.webp',
  },

  scientificInfo: 'Laser hair removal operates on the principle of selective photothermolysis, utilizing specific wavelengths of coherent light to target melanin within hair follicles while preserving surrounding tissues. The primary chromophore is eumelanin, the dark pigment found in hair shafts and follicles. Common laser systems include alexandrite lasers, diode lasers, and Nd:YAG lasers, each optimized for different skin phototypes. The laser energy is absorbed by melanin and converted to thermal energy, causing controlled thermal injury to follicular structures including the dermal papilla and bulge region containing stem cells.',

  overview: 'Laser hair removal has revolutionized the approach to unwanted hair management, offering a permanent solution that surpasses traditional methods in both effectiveness and convenience. The technology has evolved significantly since its introduction, with modern systems providing safe and effective treatment for all skin types and hair colors. The procedure represents a significant advancement in cosmetic dermatology, combining medical-grade technology with proven scientific principles to deliver lasting results.',
  ...
  faqs: [
    {
      ...
      answer: "Laser hair removal uses concentrated light energy to target melanin in hair follicles, causing thermal damage that prevents future hair growth. While individual results vary, most patients achieve significant permanent hair reduction after completing their treatment series."
    },
    {
      question: "How many sessions are typically needed for optimal results?",
      answer: "Most patients require multiple sessions spaced several weeks apart for optimal permanent hair reduction. The exact number depends on hair color, thickness, skin type, hormonal factors, and the treatment area being addressed."
    },
    {
      question: "Does laser hair removal hurt and what does it feel like?",
      answer: "Most patients describe the sensation as a rubber band snapping against the skin or warm pinpricks. Advanced cooling systems significantly minimize discomfort, making treatment much more comfortable than traditional methods like waxing."
    },
    {
      question: "What body areas can be safely treated with laser hair removal?",
      answer: "Laser hair removal can treat virtually any area of the body including face, legs, arms, underarms, bikini area, back, chest, and abdomen. Each area requires specific treatment parameters optimized for hair characteristics and skin sensitivity."
    },
    {
      question: "Is laser hair removal safe for all skin types?",
      answer: "Yes, modern laser systems are safe and effective for all skin types when appropriate technology and settings are used. Different laser wavelengths are selected based on skin tone and hair color to ensure optimal safety and efficacy."
    },
    {
      question: "What should I expect during recovery and are there side effects?",
      answer: "Most patients experience only mild redness and slight swelling that resolves within hours to days. Serious side effects are rare when proper techniques and aftercare instructions are followed. Sun protection is essential during the treatment period."
    }
  ],
  ...
  testimonials: [
    {
      name: "Amanda R.",
      rating: 5,
      quote: "After years of painful waxing and constant razor burn, laser hair removal at Vivi Aesthetics was absolutely life-changing. My legs are finally smooth and I save so much time and money!",
      treatment: "Laser Hair Removal - Full Legs"
    },
    {
      name: "Jessica T.",
      rating: 5,
      quote: "The staff made me feel completely comfortable throughout the entire process. The results exceeded my expectations - no more painful ingrown hairs and virtually hairless after the series!",
      treatment: "Laser Hair Removal - Brazilian"
    },
    {
      name: "Rachel P.",
      rating: 5,
      quote: "I was initially skeptical about the permanent results, but after completing my treatment series I have excellent hair reduction. The investment was absolutely worth it for the convenience and confidence.",
      treatment: "Laser Hair Removal - Underarms"
    },
    {
      name: "Sarah M.",
      rating: 5,
      quote: "As someone with sensitive skin who couldn't tolerate waxing, laser hair removal was perfect. The cooling system made it so comfortable, and my skin has never looked better.",
      treatment: "Laser Hair Removal - Face"
    },
    {
      name: "Michelle K.",
      rating: 5,
      quote: "The professional consultation helped set realistic expectations, and the results were exactly as promised. I love not having to think about shaving anymore - total freedom!",
      treatment: "Laser Hair Removal - Arms"
    },
    {
      name: "Jennifer L.",
      rating: 5,
      quote: "The technology is amazing - fast, effective, and much less painful than I expected. My results have been incredible. I can't believe I waited so long to try this!",
  ...
  structuredData: {
    ...
    "description": "Advanced laser hair removal treatments using selective photothermolysis for permanent hair reduction on all skin types.",
    "procedureType": "Non-invasive laser treatment",
    "bodyLocation": "Various body areas including face, legs, arms, underarms, bikini area, back, and chest",
    "image": "/images/services/laser-hair-removal/laser-hair-removal-in-calgary-001.webp",
    "url": "https://vivispa.ca/services/laser-hair-removal",
    "provider": {
      "@type": "LocalBusiness",
    ...
    "preparation": "Avoid sun exposure, discontinue plucking/waxing prior to treatment, shave treatment area before appointment",
    "howPerformed": "Targeted laser energy absorption by hair follicle melanin causing controlled thermal damage",
    "indication": {
