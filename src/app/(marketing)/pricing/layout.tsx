...
export const metadata: Metadata = generatePageMetadata({
  ...
  description: 'Explore our comprehensive range of aesthetic treatments and transparent pricing. From laser hair removal to hydrofacials, microneedling, IPL photofacial, and more at Vivi Aesthetics & Spa Calgary.',
  keywords: [
