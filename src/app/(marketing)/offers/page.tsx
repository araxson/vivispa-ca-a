...
export const metadata: Metadata = generatePageMetadata({
  title:
    "Special Offers & Promotions - Exclusive Beauty Treatment Deals | Vivi Aesthetics & Spa",
  description:
    "Save up to 40% on premium spa treatments in Calgary! Discover exclusive limited-time offers on Hydrofacials, laser hair removal, microneedling, IPL photofacial, and more aesthetic services at Vivi Aesthetics & Spa. Book now!",
  keywords: [
    "spa offers Calgary",
