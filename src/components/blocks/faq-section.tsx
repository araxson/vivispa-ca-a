...
import { Card, CardContent, Badge, Section, Container } from "@/components/ui";
...
export function FAQSection({
  ...
  if (variant === "minimal") {
    return (
      <Section spacing="lg" className={className} maxWidth="3xl">
        <SectionHeader title={title} subtitle={subtitle} />
  ...
  if (variant === "category") {
    return (
      <Section spacing="lg" className={className} maxWidth="4xl">
        <SectionHeader title={title} subtitle={subtitle} />
